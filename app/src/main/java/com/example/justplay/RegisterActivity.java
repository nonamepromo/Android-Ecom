        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!(snapshot.child(parentDbName).child(phone).exists())){
                    ...
                    Toast.makeText(RegisterActivity.this, "Questo " + phone + " è già registrato", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(RegisterActivity.this, "Per favore utilizza un altro numero di telefono", Toast.LENGTH_SHORT).show();
